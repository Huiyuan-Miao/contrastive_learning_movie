...
def parse_option():
    ...
    parser.add_argument('--data_folder', type=str, default='/media/tonglab/789aa685-f3c0-4b78-afb5-88d669eb7059/Miao/Data/theLifeOfMammals/subSample10hz/', help='path to custom dataset')
